...
Label = tk.Label(pathway, text="EVENT MANAGEMENT DIPLOMA", font=('Arial', 25))
...
Fact = """An event management diploma is a post-secondary program that prepares students for careers in the events industry. The program typically takes 1-2 years to complete and may be offered at vocational schools, community colleges, or specialized institutions.

Coursework in an event management diploma program may cover topics such as event planning and coordination, budgeting and financial management, marketing and promotions, vendor and supplier management, risk management and legal issues, and customer service. Students may also have opportunities to gain practical experience through internships or projects with local event planning companies or venues."""
