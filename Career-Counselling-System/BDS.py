...
Label = tk.Label(pathway, text="B.D.S.", font=('Arial', 25))
...
Fact = """BDS stands for Bachelor of Dental Surgery. It is an undergraduate degree program in the field of dentistry. The program typically takes four to five years to complete, depending on the institution and country.

The curriculum for the BDS program covers a range of subjects, including anatomy, physiology, pathology, dental materials, dental radiology, oral surgery, and periodontics.

After completing the program, graduates can work as dentists in government and private dental clinics, hospitals, and research institutions. They can also choose to pursue higher education in dental specialties such as orthodontics, prosthodontics, and endodontics."""
