...
Label = tk.Label(pathway, text="B.SC", font=('Arial', 25))
...
Fact = """Bachelor of Science (BSc Full Form) is a 3 year undergraduate academic degree that is nationally accepted in India. BSc Degree imparts education and skill that involves research, calculation and experimentation. BSc degree can be studied in both Honors and General courses. The difference between BSc Hons and BSc General is that BSc Hons involves a combination of elective and foundation courses whereas BSc General deals with basic knowledge about BSc."""
T.pack()
