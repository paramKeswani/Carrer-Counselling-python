...
Label = tk.Label(pathway, text="M.C.M.", font=('Arial', 25))
...
Fact = """M.C.M. stands for Master of Computer Management, and it is not an arts-related program. It is a postgraduate degree program that typically requires a bachelor's degree in computer science or a related field, but some universities may also accept candidates with a B.A. degree.

The M.C.M. program is designed to provide students with advanced knowledge and skills in the field of computer management, including topics such as database management, software development, project management, and information systems. Graduates of this program may pursue careers in IT management, software development, consulting, and other related fields."""
