...
Label = tk.Label(pathway, text="B.H.M.S.", font=('Arial', 25))
...
Fact = """BHMS stands for Bachelor of Homeopathic Medicine and Surgery. It is an undergraduate degree program in the field of homeopathy, which is a holistic system of medicine that emphasizes the body's natural healing processes.

The BHMS program typically takes five and a half years to complete, including one year of compulsory internship. The curriculum covers subjects such as anatomy, physiology, pathology, homeopathic philosophy, materia medica, and clinical training."""
