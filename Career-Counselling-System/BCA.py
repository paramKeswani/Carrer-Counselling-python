...
Label = tk.Label(pathway, text="B.C.A.", font=('Arial', 25))
...
Fact = """Bachelor of Computer Applications (BCA) is an undergraduate degree program in the field of computer applications. The course is typically three years long, although the duration may vary depending on the institution and country.

The curriculum of BCA includes a range of subjects, including programming languages, database management, software engineering, web development, computer networks, and computer architecture. The program also emphasizes the development of problem-solving, analytical, and communication skills."""
