...
Label = tk.Label(pathway, text="CALL CENTRE", font=('Arial', 25))
...
Fact = """Call center jobs involve providing customer support services over the phone, email, or chat. These jobs are typically based in customer service centers and involve handling customer inquiries, resolving complaints, and providing technical support.

Call center jobs can be categorized into two types: inbound and outbound. Inbound call center jobs involve handling incoming calls from customers who require assistance, while outbound call center jobs involve making outgoing calls to customers for marketing, sales, or customer service purposes."""
