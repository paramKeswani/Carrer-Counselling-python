...
Label = tk.Label(pathway, text="I.E.S. EXAM", font=('Arial', 25))
...
Fact = """Indian Engineering Services (IES) or Engineering Services Examination (ESE) comprise of engineers who work under the government of India and designated as Class – 1 officer. They administer a large segment of the public sector economy, which constitutes of Indian Railways, Power, Telecommunications, Central Water engineering, Defence service of Engineers, Central Engineering Service, namely."""
T.pack()
