...
Label = tk.Label(pathway, text="NDA", font=('Arial', 25))
...
Fact = """NDA stands for the National Defence Academy exam. NDA is conducted by UPSC. UPSC NDA is the national-level examination which is conducted to recruit qualified candidates as officers in the Indian Navy, Indian Army and Indian Air-force. UPSC conducts the exam for other Sarkari recruitment such as IAS, CDS, UPSC CMS, CAPF, etc. NDA exam is conducted two times a year (April & September). The exam comprises the written and SSB interviews. National Defence Academy is located in Pune, Maharashtra. Read out and get more details for NDA."""
T.pack()
