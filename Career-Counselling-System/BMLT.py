...
Label = tk.Label(pathway, text="B.M.L.T.", font=('Arial', 25))
...
Fact = """B.M.L.T. stands for Bachelor of Medical Laboratory Technology. It is an undergraduate degree program in the field of medical laboratory sciences that focuses on the study of laboratory medicine, medical technology, and laboratory research.

The program typically takes three to four years to complete, including both theoretical and practical training. The curriculum for the B.M.L.T. program covers a range of subjects, including biochemistry, microbiology, hematology, clinical pathology, blood banking, and immunology."""
