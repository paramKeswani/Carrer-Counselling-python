...
Label = tk.Label(pathway, text="Arts", font=('Times New Roman', 25))
...
btn1 = tk.Button(buttonframe, text="B.S.W.", font=('Times New Roman', 18),command=BSW)
btn1.grid(row=0, column=1, sticky=tk.W+tk.E)

btn1 = tk.Button(buttonframe, text="L.L.B. FOUNDATION", font=('Times New Roman', 18),command=LLBFOUNDATION)
btn1.grid(row=0, column=2, sticky=tk.W+tk.E)

btn1 = tk.Button(buttonframe, text="FASHION DESIGNING DIPLOMA", font=('Times New Roman', 18),command=FASHIONDESIGNINGDIPLOMA)
btn1.grid(row=1, column=0, sticky=tk.W+tk.E)

btn1 = tk.Button(buttonframe, text="INTERIOR DESIGNING DIPLOMA", font=('Times New Roman', 18),command=INTERIORDESIGNINGDIPLOMA)
btn1.grid(row=1, column=1, sticky=tk.W+tk.E)

btn1 = tk.Button(buttonframe, text="B.A.", font=('Times New Roman', 18), command=BA)
...
btn1 = tk.Button(buttonframe, text="FOREIGN LANGUAGES DIPLOMA", font=('Times New Roman', 18),command=FOREIGNLANGUAGESDIPLOMA)
