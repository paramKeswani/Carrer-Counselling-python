...
Label = tk.Label(pathway, text="COMPUTER COURSES", font=('Arial', 25))
...
Fact = """There are numerous computer courses available for students of all skill levels and interests. These courses range from basic computer literacy programs to advanced courses in specialized fields of computer science.

Some of the most popular computer courses include:

Computer Basics: These courses provide a foundation in computer literacy, covering basic concepts such as operating systems, file management, and internet browsing.

Programming Languages: Courses in programming languages such as Java, Python, C++, and JavaScript teach students the fundamentals of software development, including coding, debugging, and testing.

Web Development: These courses focus on creating and designing websites, covering topics such as HTML, CSS, JavaScript, and web frameworks."""
