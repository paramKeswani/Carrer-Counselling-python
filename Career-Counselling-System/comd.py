...
Label = tk.Label(pathway, text="COMMERCIAL DIPLOMA", font=('Arial', 25))
...
Fact = """Diploma in Commercial Practice is a business study Management course. It is a process directly connected with the supply or sale of products, promotion, or service to or from a consumer. It is a 3 years course that gives knowledge to the students in various fields like typewriting, accounting, stenography, data entry and more. After finishing this course student has many options. They can join a job or they can opt for further studies.
This course gives importance on the practical aspects of accounting. This course is designed in such a way that the student can face the challenges of the modern business environment and in turn make them employable. ."""
T.pack()
