...
Label = tk.Label(pathway, text="B.Sc HOME SCIENCE", font=('Arial', 25))
...
Fact = """B.Sc. Home Science stands for Bachelor of Science in Home Science. It is an undergraduate degree program that focuses on the study of home management, nutrition, human development, clothing, textiles, and family studies.

The program typically takes three years to complete, including both theoretical and practical training. The curriculum for the B.Sc. Home Science program covers a range of subjects, including food and nutrition, human development, textiles and clothing, communication, resource management, and family studies."""
