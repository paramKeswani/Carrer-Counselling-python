...
Label = tk.Label(pathway, text="B.Ed", font=('Arial', 25))
...
Fact = """B.Ed. stands for Bachelor of Education, and it is an undergraduate degree program that prepares individuals to become teachers. The program typically takes 2-4 years to complete, depending on the institution and the country where it is offered.

B.Ed. programs typically cover topics such as educational psychology, teaching methods and strategies, curriculum development, and classroom management. Students also gain practical teaching experience through classroom observations, supervised teaching practice, and student teaching placements."""
