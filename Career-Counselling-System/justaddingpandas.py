...
label2 = Label(my_w, text="TO TAKE THE CAREER TEST, MARK YOUR INTEREST IN EACH ACTIVITY SHOWN." ,font=('Times New Roman', 16, 'bold'),  fg='BLACK', )
label2.place(x=350,y=110)

label2 = Label(my_w, text="DO NOT WORRY ABOUT WHETHER YOU HAVE THE SKILLS OR TRAINING TO DO AN ACTIVITY, OR HOW MUCH MONEY YOU MIGHT MAKE." ,font=('Times New Roman', 16, 'bold'), fg='BLACK', )
label2.place(x=60,y=150)
label2 = Label(my_w, text=" SIMPLY THINK ABOUT WHETHER YOU WOULD ENJOY DOING IT OR NOT." ,font=('Times New Roman', 16, 'bold') , fg='BLACK', )
label2.place(x=380,y=190)

frame1 = Frame(my_w, highlightbackground="black", highlightthickness=5,bg='RosyBrown2')
frame1.pack(fill=X)
frame1.pack(padx=400,pady=(260,0),ipady=15)

frameu = Frame(frame1, width=780, height=40, bg="white",)
frameu.pack()

labela = Label(frameu, text='DISLIKE',font=('open sans', 16,'bold'), bg='white')
labela.pack(side='left', padx=(190,0))
...
question = Label(frame1,text='Analyze the structure of molecules'
...
question = Label(frame2,text='Track monthly expenses for a company',background='RosyBrown2')
question.pack(pady=(10,0),padx=10)
question.config(font=('Helvetica bold', 17))
...
question = Label(frame3,text='Write a poem',background='RosyBrown2')
question.pack(pady=(10,0),padx=10)
question.config(font=('Helvetica bold', 17))
...
question = Label(frame4,text='perform rehabilitation therapy',background='RosyBrown2')
question.pack(pady=(10,0),padx=10)
question.config(font=('Helvetica bold', 17))
...
b3 = Button(my_w, text = "NEXT",activeforeground = "green", width=10, activebackground = "pink",pady = 10,command=lambda : fun())
