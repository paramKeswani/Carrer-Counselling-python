...
Label = tk.Label(pathway, text="C.S. FOUNDATION", font=('Arial', 25))
...
Fact = """ The CS Foundation is the first level examination in the Company Secretary (CS) course in India. It is conducted by the Institute of Company Secretaries of India (ICSI) twice a year, in June and December.

The CS Foundation exam consists of four papers, which are:
