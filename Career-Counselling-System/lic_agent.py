...
Label = tk.Label(pathway, text="LIC Agent", font=('Arial', 25))
...
Fact = """Besides marketing and selling policies, LIC agents maintain records,
 help policyholders settle claims and offer advice to customers to minimise risk. 
 Depending on the area of specialisation,LIC agents may focus on only one type of policy 
 or offer their services for all types of insurance.."""
