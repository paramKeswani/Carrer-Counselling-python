...
Label = tk.Label(pathway, text="D.Ed", font=('Arial', 25))
...
Fact = """Diploma in Education (D.Ed) is a two-year diploma course in the field of education. The course is designed to train and prepare candidates to become primary school teachers.

The curriculum of D.Ed includes a range of subjects, such as child psychology, educational philosophy, teaching methods, pedagogy, and educational technology. The program also includes practical training in teaching and classroom management.

D.Ed graduates are eligible to work as primary school teachers in various schools, including government schools, private schools, and international schools. They may also pursue higher education in the field of education, such as Bachelor of Education (B.Ed) or Master of Education (M.Ed)."""
