...
Label = tk.Label(pathway, text="BACHELOR OF LIBRARY SCIENCE", font=('Arial', 25))
...
Fact = """Bachelor of Library Science (B.Lib.Sc.) is an undergraduate degree program that focuses on the principles and practices of library science. The program aims to equip students with the knowledge and skills required to manage libraries, organize and preserve information resources, and provide quality library services.

The curriculum of a B.Lib.Sc. program typically covers various topics such as library management, cataloging and classification, information retrieval, preservation and conservation of library materials, digital library management, and information technology in libraries."""
