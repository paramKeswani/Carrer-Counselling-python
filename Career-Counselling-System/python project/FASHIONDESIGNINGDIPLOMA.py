...
Label = tk.Label(pathway, text="FASHION DESIGNING DIPLOMA", font=('Arial', 25))
...
Fact = """Fashion designing diploma is a program that focuses on developing knowledge and skills in the field of fashion design. The diploma program is typically one to two years long and includes a range of subjects, such as fashion illustration, pattern-making, garment construction, fashion merchandising, and textile design.

The curriculum of fashion designing diploma programs is designed to provide practical and theoretical knowledge that enables students to understand the fashion industry and its various aspects. The program also emphasizes the development of creativity, problem-solving, and critical thinking skills."""
