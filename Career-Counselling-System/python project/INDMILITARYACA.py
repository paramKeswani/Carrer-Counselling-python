...
Label = tk.Label(pathway, text="INDIAN MILITARY ACADEMY", font=('Arial', 25))
...
Fact = """The Indian Military Academy (IMA) is an officer training academy of the Indian Army located in Dehradun, Uttarakhand, India. It was established in 1932 and is one of the most prestigious military academies in India.

The academy offers a four-year undergraduate program to train and prepare candidates for commissioned officer positions in the Indian Army. The training curriculum includes a rigorous physical fitness program, military and tactical training, leadership development, and academic instruction in subjects such as military history, strategy, and tactics."""
