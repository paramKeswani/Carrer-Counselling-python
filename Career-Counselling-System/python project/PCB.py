...
btn1 = tk.Button(buttonframe, text="B.A.M.S", font=('Arial', 18),command=BAMS)
btn1.grid(row=0, column=0, sticky=tk.W+tk.E)


btn1 = tk.Button(buttonframe, text="B.H.M.S", font=('Arial', 18),command=BHMS)
btn1.grid(row=0, column=1, sticky=tk.W+tk.E)

btn1 = tk.Button(buttonframe, text="B.V.Sc", font=('Arial', 18),command=BVSc)
btn1.grid(row=0, column=2, sticky=tk.W+tk.E)

btn1 = tk.Button(buttonframe, text="B.D.S", font=('Arial', 18),command=BDS)
btn1.grid(row=1, column=0, sticky=tk.W+tk.E)

btn1 = tk.Button(buttonframe, text="M.B.B.S", font=('Arial', 18),command=MBBS)
btn1.grid(row=1, column=1, sticky=tk.W+tk.E)

btn1 = tk.Button(buttonframe, text="PARAMEDICAL COURSES", font=('Arial', 18),command=PARAMEDICALCOURSES)
btn1.grid(row=1, column=2, sticky=tk.W+tk.E)

btn1 = tk.Button(buttonframe, text="B.Sc.NURSING", font=('Arial', 18),command=BScNURSING)
btn1.grid(row=2, column=0, sticky=tk.W+tk.E)

btn1 = tk.Button(buttonframe, text="DIPLOMA IN NURSING", font=('Arial', 18),command=DIPLOMAINNURSING)
btn1.grid(row=2, column=1, sticky=tk.W+tk.E)

btn1 = tk.Button(buttonframe, text="B.M.L.T.", font=('Arial', 18),command=BMLT)
btn1.grid(row=2, column=2, sticky=tk.W+tk.E)


btn1 = tk.Button(buttonframe, text="B.Sc. HOME SCIENCE", font=('Arial', 18),command=BScHOMESCIENCE)
btn1.grid(row=3, column=0, sticky=tk.W+tk.E)


btn1 = tk.Button(buttonframe, text="B.Sc.-Botany,Microbiology,Zoology", font=('Arial', 18),command=BScBOTANY)
