...
Label = tk.Label(pathway, text="B.Sc.-Botany,Microbiology,Zoology", font=('Arial', 25))
...
Fact = """B.Sc. Botany, Microbiology, and Zoology is an undergraduate degree program that integrates the study of three scientific disciplines: botany, microbiology, and zoology.

The program typically takes three years to complete, including both theoretical and practical training. The curriculum for the B.Sc. Botany, Microbiology, and Zoology program covers a range of subjects, including plant physiology, plant anatomy, plant taxonomy, microbiology, genetics, animal physiology, animal diversity, and ecology."""
