...
btn1 = tk.Button(buttonframe, text="PCMB", font=('Arial', 18), command=PCMB)
btn1.grid(row=0, column=0, sticky=tk.W+tk.E)


btn1 = tk.Button(buttonframe, text="PCM", font=('Arial', 18), command=PCM)
btn1.grid(row=0, column=1, sticky=tk.W+tk.E)

btn1 = tk.Button(buttonframe, text="PCB", font=('Arial', 18), command=PCB )
