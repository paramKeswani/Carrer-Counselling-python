...
Label = tk.Label(pathway, text="CLERK", font=('Arial', 25))
...
Fact = """A clerk is an administrative employee who manages various general office duties, such as typing documents, answering the phone, filing documents and entering data. Specific responsibilities vary based on the employer's requirements. A school office clerk may process student applications and answer questions about admissions, while a store clerk may process payment information and maintain the customer orders and purchase records."""
T.pack()
