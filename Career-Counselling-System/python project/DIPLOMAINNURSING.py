...
Label = tk.Label(pathway, text="DIPLOMA IN NURSING", font=('Arial', 25))
...
Fact = """Diploma in Nursing is a program that prepares students to become qualified and skilled nurses. It is an undergraduate diploma program in the field of healthcare that focuses on the care of individuals, families, and communities to maintain and promote health and well-being.

The program typically takes three years to complete, including both theoretical and practical training. The curriculum for the Diploma in Nursing program covers a range of subjects, including anatomy, physiology, pharmacology, nursing foundation, medical-surgical nursing, community health nursing, and mental health nursing."""
