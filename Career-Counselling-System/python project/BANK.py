...
Label = tk.Label(pathway, text="BANK", font=('Arial', 25))
...
Fact = """Bank jobs refer to employment opportunities in the banking sector, which includes commercial banks, investment banks, and other financial institutions. The roles available in the banking sector are diverse and can range from entry-level positions to management positions.

Some common positions in banking include teller, customer service representative, loan officer, branch manager, investment banker, financial analyst, and risk manager. These roles can vary depending on the size and type of bank, and they require different levels of education, experience, and skill sets."""
