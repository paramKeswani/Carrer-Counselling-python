...
heading = Label(pathway, text = '12th Science', font=('Microsoft Tahei UI Light', 25, 'bold'), bg='white' ,fg='firebrick1', )
heading.place(x=60,y=60)

newaccbutton = Button(pathway, text='With PCMB', font=('open sans', 16,'bold'), fg= 'white', bg='darkblue', activeforeground='white' ,activebackground='blue' ,cursor='hand2', bd=0,width=19,).place(x= 150, y=270 )
newaccbutton = Button(pathway, text='With PCM', font=('open sans', 16,'bold'), fg= 'white', bg='darkblue', activeforeground='white' ,activebackground='blue' ,cursor='hand2', bd=0,width=19,).place(x= 450, y=270 )
newaccbutton = Button(pathway, text='With PCB', font=('open sans', 16,'bold'), fg= 'white', bg='darkblue', activeforeground='white' ,activebackground='blue' ,cursor='hand2', bd=0,width=19,).place(x= 150, y=570 )
newaccbutton = Button(pathway, text='D.Ed', font=('open sans', 16,'bold'), fg= 'white', bg='darkblue', activeforeground='white' ,activebackground='blue' ,cursor='hand2', bd=0,width=19,).place(x= 450, y=570 )
