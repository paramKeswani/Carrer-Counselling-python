...
Label = tk.Label(pathway, text="ITI", font=('Arial', 25))
...
Fact = """ITI jobs refer to employment opportunities that require a diploma from an Industrial Training Institute (ITI),
 which is a vocational training institute that provides training in various trades such as electrical, 
 plumbing, welding, carpentry, and automobile repair.

Individuals who complete an ITI program can pursue various job opportunities in the industrial and manufacturing sectors,
 including roles such as fitter, mechanic, electrician, welder, and machinist. These jobs often involve working with machinery,
   tools, and equipment to manufacture, repair, or maintain various products and systems.."""
