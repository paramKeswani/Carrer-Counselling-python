...
Label = tk.Label(pathway, text="B.P.Ed", font=('Arial', 25))
...
Fact = """B.P.Ed. stands for Bachelor of Physical Education, which is a four-year undergraduate degree program that focuses on developing knowledge and skills in physical education and sports. The curriculum of the B.P.Ed program typically includes subjects such as anatomy, physiology, biomechanics, sports psychology, and pedagogy of physical education.

The B.P.Ed program is designed to prepare students for careers in various fields related to physical education and sports, such as coaching, sports management, and sports marketing. Graduates of the B.P.Ed program may also choose to pursue higher education in the field of physical education, such as a Master's degree in Physical Education."""
