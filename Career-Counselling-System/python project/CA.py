...
Label = tk.Label(pathway, text="CA", font=('Arial', 25))
...
Fact = """C.A. stands for Chartered Accountant, which is a professional designation given to individuals who have completed the necessary education and training in accounting and auditing.

Chartered Accountants provide a range of financial services to clients, including financial reporting, taxation, auditing, and consulting. They are trained to provide expert advice on financial matters, and they are often employed by corporations, government agencies, and non-profit organizations."""
