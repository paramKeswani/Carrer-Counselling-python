...
Label = tk.Label(pathway, text="CAFOUNDATION", font=('Arial', 25))
...
Fact = """The C.A. Foundation is the entry-level exam in the Chartered Accountancy course in India. It is conducted by the Institute of Chartered Accountants of India (ICAI) twice a year, in May and November.

To be eligible for the C.A. Foundation exam, a candidate must have passed the 10+2 examination or its equivalent from a recognized board or institution. There are four papers in the C.A. Foundation exam, which are:
