...
Label = tk.Label(pathway, text="M.B.A", font=('Arial', 25))
...
Fact = """M.B.A. stands for Master of Business Administration, which is a postgraduate degree program that focuses on the management and administration of business and organizations. It is a popular degree program for individuals who wish to develop their leadership and management skills and advance their careers in various industries.

The curriculum of an M.B.A. program typically covers a wide range of topics such as accounting, finance, economics, marketing, operations management, human resources, and organizational behavior. The program is designed to provide students with a broad understanding of business concepts, as well as the ability to apply these concepts in real-world situations."""
