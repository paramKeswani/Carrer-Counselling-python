...
Label = tk.Label(pathway, text="B.Sc. NURSING", font=('Arial', 25))
...
Fact = """B.Sc. Nursing stands for Bachelor of Science in Nursing. It is an undergraduate degree program in the field of healthcare that focuses on the care of individuals, families, and communities to maintain and promote health and well-being.

The program typically takes four years to complete, including both theoretical and practical training. The curriculum for the B.Sc. Nursing program covers a range of subjects, including anatomy, physiology, pharmacology, nursing foundation, medical-surgical nursing, community health nursing, and mental health nursing."""
