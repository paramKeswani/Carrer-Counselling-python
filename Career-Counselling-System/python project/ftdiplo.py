...
Label = tk.Label(pathway, text="FILM AND TECH. DIPLOMA", font=('Arial', 25))
...
Fact = """Diploma in Film Technology is a program that provides students with comprehensive training in the film industry. This course covers various aspects of filmmaking such as pre-production, production, and post-production. In this article, we will provide you with an overview of the Diploma in Film Technology program, including its highlights, entrance exam, admission process, eligibility criteria, duration, selection criteria, application process, fee, syllabus, salary and jobs, and career opportunities."""
T.pack()
