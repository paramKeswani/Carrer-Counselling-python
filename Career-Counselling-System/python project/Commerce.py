...
Label = tk.Label(pathway, text="Commerce", font=('Arial', 25))
...
btn1 = tk.Button(buttonframe, text="C.A. Foundation", font=('Arial', 18), command=CAFOUNDATION)
btn1.grid(row=0, column=0, sticky=tk.W+tk.E)


btn1 = tk.Button(buttonframe, text="B.COM", font=('Arial', 18), command=bcom)
...
btn1 = tk.Button(buttonframe, text="C.S. FOUNDATION", font=('Arial', 18),command=CSFOUNDATION)
btn1.grid(row=1, column=0, sticky=tk.W+tk.E)

btn1 = tk.Button(buttonframe, text="B.C.A", font=('Arial', 18),command=BCA)
...
btn1 = tk.Button(buttonframe, text="CALL CENTRE", font=('Arial', 18),command=CALLCENTRE)
btn1.grid(row=2, column=1, sticky=tk.W+tk.E)

btn1 = tk.Button(buttonframe, text="MPSC/UPSC", font=('Arial', 18),command=MPSC)
