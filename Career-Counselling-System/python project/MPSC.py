...
Label = tk.Label(pathway, text="M.P.S.C./U.P.S.C.", font=('Arial', 25))
...
Fact = """Candidates who successfully pass the M.P.S.C. or U.P.S.C. examinations can be recruited for a variety of civil service positions, including administrative officers, police officers, revenue officers, and tax inspectors. These positions offer stable employment with competitive salaries, as well as opportunities for career advancement and personal growth.

Preparation for these examinations can be rigorous and time-consuming, but with dedication, hard work, and the right resources, candidates can increase their chances of success. There are various coaching institutes, study materials, and online resources available to help candidates prepare for these examinations."""
