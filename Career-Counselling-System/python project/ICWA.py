...
Label = tk.Label(pathway, text="ICWA", font=('Arial', 25))
...
Fact = """I.C.W.A. stands for the Institute of Cost and Works Accountants, which is a professional body in India that offers courses and certifications in the field of cost and management accounting.

The I.C.W.A. course is designed to equip students with the skills and knowledge needed to become qualified cost accountants, who are responsible for analyzing and managing the cost and budgeting systems of an organization. The course covers topics such as financial accounting, cost accounting, management accounting, taxation, and auditing."""
