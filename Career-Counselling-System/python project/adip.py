...
Label = tk.Label(pathway, text="ART DIPLOMA", font=('Arial', 25))
...
Fact = """Generally offered as a 1-2 year program, a Diploma in Fine Arts encompasses the study of Visual Arts such as printmaking, painting, drawing, digital media, photography, etc. Fine Arts be considered the highest form of art, in a sense, because it permits, without restraints, the complete ease of expression and demonstration of the imagination of an artist. There is a wide range of specialisations in fine arts including but not limited to painting, sculpting, video design, music composition, and installation art. Studying a diploma in Fine Arts, you will be familiarized with these specialisations and further provided with the option to choose the area you are interested in.."""
