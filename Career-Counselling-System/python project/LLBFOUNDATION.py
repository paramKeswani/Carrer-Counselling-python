...
Label = tk.Label(pathway, text="L.L.B. FOUNDATION", font=('Arial', 25))
...
Fact = """L.L.B. FOUNDATION is an undergraduate degree program in law and typically takes three years to complete. The LLB program aims to provide a foundational understanding of the legal system, legal theory, and practice. Graduates of LLB programs are eligible to pursue careers in various fields of law, such as corporate law, civil law, criminal law, and litigation.

To be eligible for an LLB program, candidates typically must have completed their secondary education or equivalent with a minimum score set by the institution. Admissions are usually granted based on entrance exams, academic scores, and personal interviews."""
