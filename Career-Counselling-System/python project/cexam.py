...
Label = tk.Label(pathway, text="CLERICAL EXAM", font=('Arial', 25))
...
Fact = """Clerical aptitude test enables employers to assess the general aptitude of candidates for administrative and clerical roles. It assesses candidates on competencies, such as basic verbal ability, reasoning, numerical ability and attention to details."""
T.pack()
