...
btn1 = tk.Button(buttonframe, text="B.P.Ed", font=('Arial', 18))
btn1.grid(row=0, column=0, sticky=tk.W+tk.E)


btn1 = tk.Button(buttonframe, text="M.A", font=('Arial', 18))
btn1.grid(row=0, column=1, sticky=tk.W+tk.E)

btn1 = tk.Button(buttonframe, text="M.A. IN MASS COMMUNICATION", font=('Arial', 18))
btn1.grid(row=0, column=2, sticky=tk.W+tk.E)

btn1 = tk.Button(buttonframe, text="BACHELOR IN JOURNALISM", font=('Arial', 18))
btn1.grid(row=1, column=0, sticky=tk.W+tk.E)

btn1 = tk.Button(buttonframe, text="L.L.B", font=('Arial', 18))
btn1.grid(row=1, column=1, sticky=tk.W+tk.E)

btn1 = tk.Button(buttonframe, text="BACHELAR OF LIBRARY SCIENCE", font=('Arial', 18))
btn1.grid(row=1, column=2, sticky=tk.W+tk.E)

btn1 = tk.Button(buttonframe, text="M.B.A.", font=('Arial', 18))
btn1.grid(row=2, column=0, sticky=tk.W+tk.E)

btn1 = tk.Button(buttonframe, text="M.P.S.C/U.P.S.C.", font=('Arial', 18))
btn1.grid(row=2, column=1, sticky=tk.W+tk.E)

btn1 = tk.Button(buttonframe, text="DIPLOMA IN DRAMATISATION", font=('Arial', 18))
btn1.grid(row=2, column=2, sticky=tk.W+tk.E)


btn1 = tk.Button(buttonframe, text="M.C.A.", font=('Arial', 18))
btn1.grid(row=3, column=0, sticky=tk.W+tk.E)


btn1 = tk.Button(buttonframe, text="M.C.M", font=('Arial', 18))
btn1.grid(row=3, column=1, sticky=tk.W+tk.E)

btn1 = tk.Button(buttonframe, text="B.Ed", font=('Arial', 18))
btn1.grid(row=3, column=2, sticky=tk.W+tk.E)

btn1 = tk.Button(buttonframe, text="ADVERTISING DIPLOMA", font=('Arial', 18))
btn1.grid(row=4, column=0, sticky=tk.W+tk.E)


btn1 = tk.Button(buttonframe, text="EVENT MANAGEMENT DIPLOMA", font=('Arial', 18))
btn1.grid(row=4, column=1, sticky=tk.W+tk.E)

btn1 = tk.Button(buttonframe, text="BSF/CRPF/CISF", font=('Arial', 18))
