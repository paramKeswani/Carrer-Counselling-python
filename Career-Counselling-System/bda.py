...
Label = tk.Label(pathway, text="BDA", font=('Arial', 25))
...
Fact = """Bachelor of Planning or B. Planning is a 4-year undergraduate programme designed to introduce students to the fundamentals of urban planning, development and settlement. As the needs of modern civilisation become more complex and demanding, the need for professional planners increases. From identifying urban problems to the preservation of historical and cultural entities; planners play a critical role in transforming and shaping our environment. If you want to pursue planning after the 12th, then keep on reading because we are going to cover all the essentials of a Bachelor of Planning!    """
T.pack()
