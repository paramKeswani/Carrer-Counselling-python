...
question = Label(frame1,text='Look at cells through a microscope'
...
question = Label(frame2,text='Review financial records for accuracy',background='RosyBrown2')
question.pack(pady=(50,0),padx=10)
question.config(font=('Helvetica bold', 17))
...
question = Label(frame3,text='compose or arrange music',background='RosyBrown2')
question.pack(pady=(50,0),padx=10)
question.config(font=('Helvetica bold', 17))
...
question = Label(frame4,text='learning about monuments in museum',background='RosyBrown2')
question.pack(pady=(50,0),padx=10)
question.config(font=('Helvetica bold', 17))
