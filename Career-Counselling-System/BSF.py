...
Label = tk.Label(pathway, text="BSF/CRPF/CISF", font=('Arial', 25))
...
Fact = """BSF, CRPF, and CISF are three different paramilitary forces in India:

BSF (Border Security Force): It is responsible for guarding India's land borders and preventing smuggling, infiltration, and illegal activities. It also assists in maintaining law and order in times of national emergencies.

CRPF (Central Reserve Police Force): It is the largest paramilitary force in India and is responsible for maintaining law and order in various states, as well as providing security for elections, VIPs, and other important events.

CISF (Central Industrial Security Force): It is responsible for providing security to key installations, such as airports, seaports, nuclear power plants, and other important government buildings and infrastructure."""
