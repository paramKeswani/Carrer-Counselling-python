...
Label = tk.Label(pathway, text="MEd", font=('Arial', 25))
...
Fact = """M.Ed. stands for Master of Education, which is a postgraduate degree program designed for individuals who want to advance their careers in education or specialize in a particular area of education.

The curriculum of an M.Ed. program typically covers a wide range of topics such as educational psychology, curriculum and instruction, assessment and evaluation, educational leadership, and technology in education. The program focuses on providing students with advanced knowledge and skills in education and preparing them for leadership roles in various educational settings"""
