...
Label = tk.Label(pathway, text="DIPLOMA IN DANCE AND MUSIC", font=('Arial', 25))
...
Fact = """Diploma In Dance is an intensive dance course that focuses on five key areas, namely dance technique, contextual research, dance practice, teaching skills, and choreography. The duration of diploma dance courses is generally from 6 months to 3 year. The main purpose of exposing this kind of diploma courses in dance is to help students or rising artists to exhibit and show their artistic talent to the world.

Students who have basic dancing skills and have passed the 10+2 examination are eligible to apply for the Diploma In Dancing course. The general eligibility requirements for the course is that aspirants must pass 10+2 with minimum 45% marks and may know how to write and speak in english. Also they must have basic knowledge of dancing. The admission criteria for Diploma in dance courses may vary from institute to institute. ."""
T.pack()
