...
Label = tk.Label(pathway, text="INTERIOR DESIGNING DIPLOMA", font=('Arial', 25))
...
Fact = """ Interior designing diploma is a program that focuses on developing knowledge and skills in the field of interior design. The diploma program is typically one to two years long and includes a range of subjects, such as space planning, color theory, furniture design, lighting, and building codes.

The curriculum of interior designing diploma programs is designed to provide practical and theoretical knowledge that enables students to understand the principles of interior design and its various aspects. The program also emphasizes the development of creativity, problem-solving, and critical thinking skills."""
