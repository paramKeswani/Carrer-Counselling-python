...
Label = tk.Label(pathway, text="B.B.A.", font=('Arial', 25))
...
Fact = """BBA is an undergraduate degree program in the field of business management. The course is typically three years long, although the duration may vary depending on the institution and country. BBA is designed to provide students with a strong foundation in business management and entrepreneurship, with a focus on practical skills and real-world applications.

The curriculum of BBA includes a range of subjects, including accounting, economics, finance, marketing, operations management, organizational behavior, and strategic management. The program also emphasizes the development of soft skills such as communication, leadership, teamwork, and problem-solving."""
