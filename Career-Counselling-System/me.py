...
Label = tk.Label(pathway, text="M.E.", font=('Arial', 25))
...
Fact = """The Masters of Engineering course is a two-year postgraduate engineering course that focuses on advanced theoretical understanding and the engineering element of science. ME course duration is 2 years and includes 4 semesters. Candidates can pursue this course after completing a bachelor’s degree in a related specialization. ME course eligibility states that the candidate must have passed an undergraduate degree in science or technology with 50/ 60% marks from a recognized board. Admission to this course is done via ME entrance exams like JEE Main, JEE Advanced, GATE, GRE, BITS ME, etc."""
T.pack()
