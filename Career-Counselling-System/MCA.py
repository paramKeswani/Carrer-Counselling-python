...
Label = tk.Label(pathway, text="M.C.A.", font=('Arial', 25))
...
Fact = """M.C.A. stands for Master of Computer Applications, which is a postgraduate degree program that focuses on computer science and application development. The program aims to equip students with advanced knowledge and skills in programming, software development, database management, and other areas of computer science.

The curriculum of an M.C.A. program typically covers various topics such as programming languages, database management, software engineering, computer networks, web development, and project management. The program also includes practical training in software development and project management, allowing students to gain hands-on experience in the field."""
