...
image = image.resize((150, 130), resample=resample_filter)
...
def home():
    my_w.destroy()
    import quiz2
newaccbutton = Button(my_w, text="Previous", font=('open sans', 12,'bold'), fg= 'white', bg='black', activeforeground='white' ,activebackground='black' ,cursor='hand2', bd=0,width=12,command= firstpage).place(x= 350, y=800 ) 
my_w.mainloop()