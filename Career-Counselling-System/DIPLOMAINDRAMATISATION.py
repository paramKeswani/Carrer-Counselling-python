...
Label = tk.Label(pathway, text="DIPLOMA IN DRAMATISATION", font=('Arial', 25))
...
Fact = """Bachelor in Journalism is an undergraduate degree program that focuses on developing knowledge and skills in various areas of journalism, such as news reporting, feature writing, editing, and media law and ethics. The curriculum of the Bachelor in Journalism program typically includes subjects such as media history, media research, media management, and production techniques.

The Bachelor in Journalism program is usually three years long and includes a combination of coursework and practical projects. The coursework is designed to provide students with a comprehensive understanding of the media industry, including the role of media in society, the history of media, and the impact of technology on media."""
