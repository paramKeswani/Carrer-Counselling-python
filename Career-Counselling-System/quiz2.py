...
my_w.title('TEST | Career Counselling System')
...
label2 = Label(my_w, text="TO TAKE THE CAREER TEST, MARK YOUR INTEREST IN EACH ACTIVITY SHOWN." ,font=('Microsoft Tahei UI Light', 16, 'bold'),bg='black' , fg='firebrick1', )
label2.place(x=350,y=110)

label2 = Label(my_w, text="DO NOT WORRY ABOUT WHETHER YOU HAVE THE SKILLS OR TRAINING TO DO AN ACTIVITY, OR HOW MUCH MONEY YOU MIGHT MAKE." ,font=('Microsoft Tahei UI Light', 16, 'bold'),bg='black' , fg='firebrick1', )
label2.place(x=60,y=150)
label2 = Label(my_w, text=" SIMPLY THINK ABOUT WHETHER YOU WOULD ENJOY DOING IT OR NOT." ,font=('Microsoft Tahei UI Light', 16, 'bold'),bg='black' , fg='firebrick1', )
label2.place(x=380,y=190)

frame1 = Frame(my_w, highlightbackground="black", highlightthickness=5,bg='RosyBrown2')
frame1.pack(fill=X)
frame1.pack(padx=400,pady=(250,0),ipady=15)

frameu = Frame(frame1, width=780, height=40, bg="white",)
frameu.pack()

labela = Label(frameu, text='DISLIKE',font=('open sans', 16,'bold'), bg='white')
labela.pack(side='left', padx=(170,0))
...
dislike.pack(side=LEFT,pady=(17,0),padx=(180,0))
dislike.config(font=('Helvetica bold', 15))


q_1_v = DoubleVar()

q_11 = Radiobutton(frame1, variable=q_1_v, value=1,command=lambda :add_data(num1,q_1_v),bg='RosyBrown2')
q_11.pack(side =  LEFT,  fill =BOTH,padx=(20,0))
q_11.pack(pady=(17,0))

q_12 = Radiobutton(frame1, variable=q_1_v, value=2,command=lambda :add_data(num1,q_1_v),bg='RosyBrown2')
q_12.pack(side =  LEFT,  fill = BOTH,padx=(10,0))
q_12.pack(pady=(17,0))

q_13 = Radiobutton(frame1, variable=q_1_v, value=3,command=lambda :add_data(num1,q_1_v),bg='RosyBrown2')
q_13.pack(side = LEFT,  fill = BOTH,padx=(10,0))
q_13.pack(pady=(17,0))

q_14 = Radiobutton(frame1, variable=q_1_v, value=4,command=lambda :add_data(num1,q_1_v),bg='RosyBrown2')
q_14.pack(side =  LEFT,  fill = BOTH,padx=(10,0))
q_14.pack(pady=(17,0))

q_15 = Radiobutton(frame1, variable=q_1_v, value=5,command=lambda :add_data(num1,q_1_v),bg='RosyBrown2')
...
q_21 = Radiobutton(frame2, variable=q_2_v, value=1,command=lambda :add_data(num2,q_2_v),bg='RosyBrown2')
q_21.pack(side =  LEFT,  fill =BOTH,padx=(20,0))
q_21.pack(pady=(17,0))

q_22 = Radiobutton(frame2, variable=q_2_v, value=2,command=lambda :add_data(num2,q_2_v),bg='RosyBrown2')
q_22.pack(side =  LEFT,  fill = BOTH,padx=(10,0))
q_22.pack(pady=(17,0))

q_23 = Radiobutton(frame2, variable=q_2_v, value=3,command=lambda :add_data(num2,q_2_v),bg='RosyBrown2')
q_23.pack(side = LEFT,  fill = BOTH,padx=(10,0))
q_23.pack(pady=(17,0))

q_24 = Radiobutton(frame2, variable=q_2_v, value=4,command=lambda :add_data(num2,q_2_v),bg='RosyBrown2')
q_24.pack(side =  LEFT,  fill = BOTH,padx=(10,0))
q_24.pack(pady=(17,0))

q_25 = Radiobutton(frame2, variable=q_2_v, value=5,command=lambda :add_data(num2,q_2_v),bg='RosyBrown2')
...
q_31 = Radiobutton(frame3, variable=q_3_v, value=1,command=lambda :add_data(num3,q_3_v),bg='RosyBrown2')
q_31.pack(side =  LEFT,  fill =BOTH,padx=(20,0))
q_31.pack(pady=(17,0))

q_32 = Radiobutton(frame3, variable=q_3_v, value=2,command=lambda :add_data(num3,q_3_v),bg='RosyBrown2')
q_32.pack(side =  LEFT,  fill = BOTH,padx=(10,0))
q_32.pack(pady=(17,0))

q_33 = Radiobutton(frame3, variable=q_3_v, value=3,command=lambda :add_data(num3,q_3_v),bg='RosyBrown2')
q_33.pack(side = LEFT,  fill = BOTH,padx=(10,0))
q_33.pack(pady=(17,0))

q_34 = Radiobutton(frame3, variable=q_3_v, value=4,command=lambda :add_data(num3,q_3_v),bg='RosyBrown2')
q_34.pack(side =  LEFT,  fill = BOTH,padx=(10,0))
q_34.pack(pady=(17,0))

q_35 = Radiobutton(frame3, variable=q_3_v, value=5,command=lambda :add_data(num3,q_3_v),bg='RosyBrown2')
...
q_41 = Radiobutton(frame4, variable=q_4_v, value=1,command=lambda :add_data(num4,q_4_v),bg='RosyBrown2')
q_41.pack(side =  LEFT,  fill =BOTH,padx=(20,0))
q_41.pack(pady=(17,0))

q_42 = Radiobutton(frame4, variable=q_4_v, value=2,command=lambda :add_data(num4,q_4_v),bg='RosyBrown2')
q_42.pack(side =  LEFT,  fill = BOTH,padx=(10,0))
q_42.pack(pady=(17,0))

q_43 = Radiobutton(frame4, variable=q_4_v, value=3,command=lambda :add_data(num4,q_4_v),bg='RosyBrown2')
q_43.pack(side = LEFT,  fill = BOTH,padx=(10,0))
q_43.pack(pady=(17,0))

q_44 = Radiobutton(frame4, variable=q_4_v, value=4,command=lambda :add_data(num4,q_4_v),bg='RosyBrown2')
q_44.pack(side =  LEFT,  fill = BOTH,padx=(10,0))
q_44.pack(pady=(17,0))

q_45 = Radiobutton(frame4, variable=q_4_v, value=5,command=lambda :add_data(num4,q_4_v),bg='RosyBrown2')
...
def home():
    my_w.destroy()
    import quiz3
newaccbutton = Button(my_w, text="Next", font=('open sans', 12,'bold'), fg= 'white', bg='black', activeforeground='white' ,activebackground='black' ,cursor='hand2', bd=0,width=12,command= home).place(x= 1150, y=800 ) 
my_w.mainloop()